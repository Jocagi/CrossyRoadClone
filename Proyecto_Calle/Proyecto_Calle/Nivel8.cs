...
{
    public partial class Nivel8 : Form
    {
        //Guardado
        int identificador = 7; //Este nivel
        ...
        public void CarrosAleatorios(List<PictureBox> Carros, Form Juego, int carril) //Aparicion de carros
        {
            ...
            if (Probabilidad > 75 && Probabilidad <= 90) //10% de apararicion de carros azules
            {
                Color = "Azul";
            }
            if (Probabilidad > 90 && Probabilidad <= 98) //4% de apararicion de carros rojos
            {
                Color = "Rojo";
            }
