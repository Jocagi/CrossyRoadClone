...
{
    public partial class Nivel7 : Form
    {
        //Guardado
        int identificador = 6; //Este nivel
        ...
        public void CarrosAleatorios(List<PictureBox> Carros, Form Juego, int carril) //Aparicion de carros
        {
            ...
            if (Probabilidad <= 40) //40% de apararicion de carros amarillos
            {
                Color = "Amarillo";
            }
            if (Probabilidad > 40 && Probabilidad <= 85) //45% de apararicion de carros verdes
            {
                Color = "Verde";
            }
            if (Probabilidad > 85 && Probabilidad <= 94) //10% de apararicion de carros azules
            {
                Color = "Azul";
            }
