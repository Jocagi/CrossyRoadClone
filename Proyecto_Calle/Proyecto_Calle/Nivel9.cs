...
{
    public partial class Nivel9 : Form
    {
        //Guardado
        int identificador = 8; //Este nivel
        ...
        public void CarrosAleatorios(List<PictureBox> Carros, Form Juego, int carril) //Aparicion de carros
        {
            ...
            if (Probabilidad <= 70) //40% de apararicion de carros amarillos
            {
                Color = "Amarillo";
            }
            if (Probabilidad > 70 && Probabilidad <= 75) //45% de apararicion de carros verdes
            {
                Color = "Verde";
            }
            if (Probabilidad > 75 && Probabilidad <= 80) //10% de apararicion de carros azules
            {
                Color = "Azul";
            }
            if (Probabilidad > 80 && Probabilidad <= 98) //4% de apararicion de carros rojos
            {
                Color = "Rojo";
            }
            ...
            try
            {
                ...
                if (pausa == false)
                {
                    ...
                    if (Detener_Carros.Enabled == false)
                    {
                        ...
                        {
                            //Resetear ancianos
                            if (ListaCarros[i].Bounds.IntersectsWith(Perro_Imagen.Bounds) && anciano == false)
                            {
                                Crear_Perro();
                            }
            ...
            if (Mover_Personaje == true)
            {
                if (pausa == false)
                {
                    ...
                    if (agarrar == true)
                    {
                        ...
                        if (Jugador.Bounds.IntersectsWith(Perro_Imagen.Bounds))
                        {
                            anciano = true;

                            Movimiento_Combinado = true;

                            Perro_Imagen.Location = new Point(Jugador.Location.X + 55, Jugador.Location.Y);
                    ...
                    if (Movimiento_Combinado == true)
                    {
                        Perro_Imagen.Location = new Point(x + 55, y);
                    }
                    ...
                    if (Movimiento_Combinado == false && liberar == true && Perro_Imagen.Bounds.IntersectsWith(Meta.Bounds))
                    {
        ...
        public void Crear_Perro()
        {
            ...
            posx = lugar.Next(150, 600);
           
            Perro_Imagen.Location = new Point(posx, posy);
        }
