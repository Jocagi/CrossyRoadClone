...
namespace Proyecto_Calle
{
    ...
    {
        //Guardado
        int identificador = 2; //Este nivel
        ...
        public void CarrosAleatorios(List<PictureBox> Carros, Form Juego, int carril) //Aparicion de carros
        {
            ...
            if (Probabilidad <= 30) //30% de apararicion de carros amarillos
            {
                Color = "Amarillo";
            }
            if (Probabilidad > 30 && Probabilidad <= 35) //5% de apararicion de carros verdes
            {
                Color = "Verde";
            }
            if (Probabilidad > 35 && Probabilidad <= 40) //5% de apararicion de carros azules
            {
                Color = "Azul";
            }
            if (Probabilidad > 40 && Probabilidad <= 70) //30% de apararicion de carros rojos
            {
                Color = "Rojo";
            }
            if (Probabilidad > 70) //30% de aparicion de carros negros
            {
                Color = "Negro";
            }
